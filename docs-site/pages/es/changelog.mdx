...
Esta pagina proporciona un resumen del registro de cambios de CypherLite. El registro completo se mantiene en ingles.

Para el historial completo de versiones, consulte [CHANGELOG.md](https://github.com/Epsilondelta-ai/CypherLite/blob/main/CHANGELOG.md) on GitHub.
