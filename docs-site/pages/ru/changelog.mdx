...
Эта страница содержит краткий обзор истории изменений CypherLite. Полная история ведётся на английском языке.

Полную историю версий смотрите в [CHANGELOG.md](https://github.com/Epsilondelta-ai/CypherLite/blob/main/CHANGELOG.md) on GitHub.
