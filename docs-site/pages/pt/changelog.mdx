...
Esta pagina fornece um resumo do registro de alteracoes do CypherLite. O registro completo e mantido em ingles.

Para o historico completo de versoes, consulte [CHANGELOG.md](https://github.com/Epsilondelta-ai/CypherLite/blob/main/CHANGELOG.md) on GitHub.
