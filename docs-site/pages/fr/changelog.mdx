...
Cette page fournit un resume du journal des modifications de CypherLite. Le journal complet est maintenu en anglais.

Pour l'historique complet des versions, consultez [CHANGELOG.md](https://github.com/Epsilondelta-ai/CypherLite/blob/main/CHANGELOG.md) on GitHub.
