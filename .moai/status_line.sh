...
if [ -f "/Users/epsilondelta/go/bin/moai" ]; then
	exec "/Users/epsilondelta/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/epsilondelta/.local/bin/moai" ]; then
	exec "/Users/epsilondelta/.local/bin/moai" statusline < "$temp_file"
fi
